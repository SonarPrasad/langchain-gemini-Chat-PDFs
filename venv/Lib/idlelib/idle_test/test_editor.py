...
class GetLineIndentTest(unittest.TestCase):
        ...
        for tabwidth in [1, 2, 4, 6, 8]:
            for line in ["", "\n"]:
                with self.subTest(line=line, tabwidth=tabwidth):
                    self.assertEqual(
                        editor.get_line_indent(line, tabwidth=tabwidth), (0, 0),
                    )
    ...
    def test_tabwidth_4(self):
        ...
        for line, expected in tests:
            with self.subTest(line=line):
                self.assertEqual(
                    editor.get_line_indent(line, tabwidth=4), expected,
                )
    ...
    def test_tabwidth_8(self):
        ...
        for line, expected in tests:
            with self.subTest(line=line):
                self.assertEqual(
                    editor.get_line_indent(line, tabwidth=8), expected,
                )
...
class IndentAndNewlineTest(unittest.TestCase):
    ...
    def test_indent_and_newline_event(self):
        ...
        tests = (
            TestInfo(
                "Empty line inserts with no indent.",
                "  \n  def __init__(self):",
                "\n  \n  def __init__(self):\n",
                "1.end",
            ),
            TestInfo(
                "Inside bracket before space, deletes space.",
                "  def f1(self, a, b):",
                "  def f1(self,\n         a, b):\n",
                "1.14",
            ),
            TestInfo(
                "Inside bracket after space, deletes space.",
                "  def f1(self, a, b):",
                "  def f1(self,\n         a, b):\n",
                "1.15",
            ),
            TestInfo(
                "Inside string with one line - no indent.",
                '  """Docstring."""',
                '  """Docstring.\n"""\n',
                "1.15",
            ),
            TestInfo(
                "Inside string with more than one line.",
                '  """Docstring.\n  Docstring Line 2"""',
                '  """Docstring.\n  Docstring Line 2\n  """\n',
                "2.18",
            ),
            TestInfo("Backslash with one line.", "a =\\", "a =\\\n  \n", "1.end"),
            TestInfo(
                "Backslash with more than one line.",
                "a =\\\n          multiline\\",
                "a =\\\n          multiline\\\n          \n",
                "2.end",
            ),
            TestInfo(
                "Block opener - indents +1 level.",
                "  def f1(self):\n    pass",
                "  def f1(self):\n    \n    pass\n",
                "1.end",
            ),
            TestInfo(
                "Block closer - dedents -1 level.",
                "  def f1(self):\n    pass",
                "  def f1(self):\n    pass\n  \n",
                "2.end",
            ),
