...
AboutDialog_spec = {
    "file": "help_about",
    "kwds": {"title": "help_about test", "_htest": True,},
...
ConfigDialog_spec = {
    "file": "configdialog",
    "kwds": {"title": "ConfigDialogTest", "_htest": True,},
...
CustomRun_spec = {
    "file": "query",
    "kwds": {"title": "Customize query.py Run", "_htest": True},
