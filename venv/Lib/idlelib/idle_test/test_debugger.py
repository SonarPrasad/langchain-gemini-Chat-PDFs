...
class IdbTest(unittest.TestCase):
    ...
    def test_user_exception(self):
        ...
        self.gui.interaction.assert_called_once_with(self.msg, self.frame, exc_info)
...
class FunctionTest(unittest.TestCase):
    ...
    def test_functions(self):
        ...
        self.assertEqual(debugger._frame2message(rpc_frame), "rpc.py:2: <module>()")
...
class StackViewerTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.stack = [(MockFrame(self.code, 1), 1), (MockFrame(self.code, 2), 2)]
