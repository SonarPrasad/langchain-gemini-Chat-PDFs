...
class GetKeysFrame(Frame):
    ...
    def create_widgets(self):
        ...
        self.list_keys_final = Listbox(
            self.frame_controls_basic, width=15, height=10, selectmode="single"
        )
        ...
        self.button_clear = Button(
            self.frame_controls_basic, text="Clear Keys", command=self.clear_key_seq
        )
        ...
        self.button_level = Button(
            self, command=self.toggle_level, text="<< Basic Key Binding Entry"
        )
